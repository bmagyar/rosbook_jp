...
\item ROS\footnote{\url{http://www.ros.org/}}，OSRF(Open Source Robotics Foundation)\footnote{\url{http://www.osrfoundation.org/}} (米国)
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\columnwidth]{pictures/chapter1/pic_01_01.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\columnwidth]{pictures/chapter1/pic_01_02.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\columnwidth]{pictures/chapter1/pic_01_03.png}
  \caption{ROS生態系}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\columnwidth]{pictures/chapter1/pic_01_04.png}
...
■2000：Player/Stage Project、Brian Gerkey、Richard Vaughan、Andrew Howard、南カリフォルニア大学


\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\columnwidth]{pictures/chapter1/pic_01_05.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\columnwidth]{pictures/chapter1/pic_01_06.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\columnwidth]{pictures/chapter1/pic_01_07.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\columnwidth]{pictures/chapter1/pic_01_08.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\columnwidth]{pictures/chapter1/pic_01_09.png}
  \caption{Indigo Iglooのバージョンの移植状況}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\columnwidth]{pictures/chapter1/pic_01_10.png}
...
■オペレーティングシステム：Ubuntu 14.04 Trusty Tahr（LTS）
■ROSのバージョン：ROS Indigo Igloo
